...
if [ ! -f "$archive" ]; then
  curl --fail --location --retry 3 --connect-timeout 20 --max-time 180 https://github.com/sparkle-project/Sparkle/releases/download/2.9.6/Sparkle-2.9.6.tar.xz -o "$archive.tmp"
